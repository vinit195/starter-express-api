...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    const Type = req.body.AGUBUN || "package";
...
export const imageUpload2 = multer({
  storage: storage,
  limits: { fileSize: 100 * 1024 * 1024, fieldSize: 20 * 1024 * 1024 }, // 50MB limit
...
export const imageUpload2_1 = multer({
  storage: storage,
  limits: { fileSize: 5 * 1024 * 1024, fieldSize: 200 * 1024 * 1024 }, // 5MB limit
  fileFilter: fileFilter,
});

export const restaurant_imageUpload = multer({
  storage: storage,
  limits: { fileSize: 5 * 1024 * 1024, fieldSize: 200 * 1024 * 1024 }, // 5MB limit
  fileFilter: fileFilter,
});
